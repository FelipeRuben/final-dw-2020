    ...
    if (err) {
      ...
      if (!userData) {
        ...
        if (req.files) {
          ...
          let fileName = filePath.replace(/^.*[\\\/]/, ""); //agregar esta ruta
          // let fileSplit = filePath.split("/");//////////////////////quitar los dos comentados
          ...
          if (fileExt !== "png" && fileExt !== "jpg") {
            res.status(400).send({
              message:
                "Extension de imagen no valida. (Extensiones permitidas: .png y .jpg)",
            });
          } else {
